      ...
      >
        ...
        >
          ...
          <button
            ...
            className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded border border-white/10 text-white/70 transition-colors duration-300 hover:border-neon/40 hover:text-neon md:hidden"
          >
